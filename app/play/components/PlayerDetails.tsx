...
const PlayerDetails = ({ player }: PlayerDetailsProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={player == "player 1" ? PlayerOne : PlayerTwo}
      ...
      <h3 className="heading-s text-black">
        {
          playerNamesMap?.[
            player == "player 1" ? Player.PLAYER_ONE : Player.PLAYER_TWO
          ]
        }
      </h3>
      <h2 className="heading-l text-black">
        {player == "player 1" ? playerOneScore : playerTwoScore}
      </h2>
    </div>
  );
};
