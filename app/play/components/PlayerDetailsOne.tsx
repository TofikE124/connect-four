...
const PlayerDetailsOne = () => {
  ...
  return (
    <div className="grid-in-playerOne relative w-fit  mdsm:w-full h-fit  flex flex-col md:flex-row items-center justify-center mdsm:justify-between pt-12 pb-4 px-7 md:py-2 sm:py-2 md:pl-11 md:pr-5 sm:px-2 rounded-[20px] border-[3px] border-solid border-black bg-white text-black shadow-[0px_10px_0px_black]">
