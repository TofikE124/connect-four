...
const page = () => {
  return (
    <div className="w-screen h-screen grid place-items-center bg-purple sm:py-4 overflow-y-scroll">
      <div className="bg-white h-fit lgmd:max-w-[480px] sm:mx-[5vw] sm:max-w-[340px] relative space-y-7 pt-[30px] lgmd:pb-[56px] sm:pb-20 lgmd:px-[34px] sm:px-5 rounded-[40px] shadow-[0px_10px_0px_0px_black] border-[3px] border-solid border-black mb-[50px]">
