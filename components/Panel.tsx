...
const Panel = ({
  ...
  return (
    ...
    >
      <div
        className={twMerge(
          `relative z-30 bg-purple border-[3px] border-solid border-black shadow-[0px_10px_0px_0px_black] dark:bg-dark-grey px-10 sm:px-5 py-[50px] sm:py-[30px] rounded-[40px] max-w-[480px] sm:max-w-[90%] transition-transform duration-300 ${
